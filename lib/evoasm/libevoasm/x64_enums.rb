...
module Evoasm
  module Libevoasm
    ...
    enum :x64_inst_id, [
      ...
      :vgatherdpd_xmm_vm32x_xmm, 1579,
      :vgatherqpd_xmm_vm64x_xmm, 1580,
      :vgatherdpd_ymm_vm32x_ymm, 1581,
      :vgatherqpd_ymm_vm64y_ymm, 1582,
      :vgatherdps_xmm_vm32x_xmm, 1583,
      :vgatherqps_xmm_vm64x_xmm, 1584,
      :vgatherdps_ymm_vm32y_ymm, 1585,
      :vgatherqps_xmm_vm64y_xmm, 1586,
      :vpgatherdd_xmm_vm32x_xmm, 1587,
      :vpgatherqd_xmm_vm64x_xmm, 1588,
      :vpgatherdd_ymm_vm32y_ymm, 1589,
      :vpgatherqd_xmm_vm64y_xmm, 1590,
      :vpgatherdq_xmm_vm32x_xmm, 1591,
      :vpgatherqq_xmm_vm64x_xmm, 1592,
      :vpgatherdq_ymm_vm32x_ymm, 1593,
      :vpgatherqq_ymm_vm64y_ymm, 1594,
