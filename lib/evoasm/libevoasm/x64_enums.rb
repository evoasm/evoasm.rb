...
module Evoasm
  module Libevoasm
    ...
    enum :x64_inst_id, [
      ...
      :enter_imm16_imm8_0, 348,
      :enter_imm16_imm8_1, 349,
      ...
      :movlps_m64_xmm, 557,
      :vmovlps_m64_xmm, 558,
      :movmskpd_r64_xmm, 559,
      :vmovmskpd_r64_xmm, 560,
      :vmovmskpd_r64_ymm, 561,
      :movmskps_r64_xmm, 562,
      :vmovmskps_r64_xmm, 563,
      :vmovmskps_r64_ymm, 564,
      ...
      :pextrb_rm8_xmm_imm8, 815,
      :pextrd_rm32_xmm_imm8, 816,
      :pextrq_rm64_xmm_imm8, 817,
      :vpextrb_rm8_xmm_imm8, 818,
      :vpextrd_rm32_xmm_imm8, 819,
      :vpextrq_rm64_xmm_imm8, 820,
      :pextrw_r64_mm_imm8, 821,
      :pextrw_r64_xmm_imm8, 822,
      :pextrw_rm16_xmm_imm8, 823,
      :vpextrw_r64_xmm_imm8, 824,
      :vpextrw_rm16_xmm_imm8, 825,
      :phaddw_mm_mmm64, 826,
      ...
      :pmovmskb_r64_mm, 909,
      :pmovmskb_r64_xmm, 910,
      :vpmovmskb_r64_xmm, 911,
      :vpmovmskb_r64_ymm, 912,
      ...
      :sal_shl_rm16_1_0, 1281,
      :sal_shl_rm16_cl_0, 1282,
      :sal_shl_rm16_imm8, 1283,
      :sal_shl_rm32_1_0, 1284,
      :sal_shl_rm64_1_0, 1285,
      :sal_shl_rm32_cl_0, 1286,
      :sal_shl_rm64_cl_0, 1287,
      ...
      :sar_rm32_imm8, 1300,
      :sar_rm64_imm8, 1301,
      :sal_shl_rm16_1_1, 1302,
      :sal_shl_rm16_cl_1, 1303,
      :sal_shl_rm32_1_1, 1304,
      :sal_shl_rm64_1_1, 1305,
      :sal_shl_rm32_cl_1, 1306,
      :sal_shl_rm64_cl_1, 1307,
      :shr_rm8_1, 1308,
      :shr_rm8_cl, 1309,
      :shr_rm8_imm8, 1310,
      :shr_rm16_1, 1311,
      ...
      :vperm2f128_ymm_ymm_ymmm256_imm8, 1605,
      :vperm2i128_ymm_ymm_ymmm256_imm8, 1606,
      :vpermd_ymm_ymm_ymmm256, 1607,
      ...
      :vpermpd_ymm_ymmm256_imm8, 1616,
      :vpermps_ymm_ymm_ymmm256, 1617,
      :vpermq_ymm_ymmm256_imm8, 1618,
      :vpmaskmovd_xmm_xmm_m128, 1619,
      :vpmaskmovd_ymm_ymm_m256, 1620,
      :vpmaskmovq_xmm_xmm_m128, 1621,
      :vpmaskmovq_ymm_ymm_m256, 1622,
      :vpmaskmovd_m128_xmm_xmm, 1623,
      :vpmaskmovd_m256_ymm_ymm, 1624,
      :vpmaskmovq_m128_xmm_xmm, 1625,
      :vpmaskmovq_m256_ymm_ymm, 1626,
      :vpsllvd_xmm_xmm_xmmm128, 1627,
      :vpsllvq_xmm_xmm_xmmm128, 1628,
      :vpsllvd_ymm_ymm_ymmm256, 1629,
      :vpsllvq_ymm_ymm_ymmm256, 1630,
      :vpsravd_xmm_xmm_xmmm128, 1631,
      :vpsravd_ymm_ymm_ymmm256, 1632,
      :vpsrlvd_xmm_xmm_xmmm128, 1633,
      :vpsrlvq_xmm_xmm_xmmm128, 1634,
      :vpsrlvd_ymm_ymm_ymmm256, 1635,
      :vpsrlvq_ymm_ymm_ymmm256, 1636,
      :vtestps_xmm_xmmm128, 1637,
      :vtestps_ymm_ymmm256, 1638,
      :vtestpd_xmm_xmmm128, 1639,
      :vtestpd_ymm_ymmm256, 1640,
      :vzeroall, 1641,
      :vzeroupper, 1642,
      :xabort_imm8, 1643,
      :xadd_rm8_r8, 1644,
      ...
      :xor_r32_rm32, 1676,
      :xor_r64_rm64, 1677,
      :xorpd_xmm_xmmm128, 1678,
      :vxorpd_xmm_xmm_xmmm128, 1679,
      :vxorpd_ymm_ymm_ymmm256, 1680,
      :xorps_xmm_xmmm128, 1681,
      :vxorps_xmm_xmm_xmmm128, 1682,
      :vxorps_ymm_ymm_ymmm256, 1683,
      :xtest, 1684,
      :n_insts
    ]
