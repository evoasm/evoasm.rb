module Awasm
  class Search
    ...
    def initialize(arch, examples:, instructions:, program_size:,
                   population_size:, parameters:, mutation_rate: 0.10,
                   seed: DEFAULT_SEED, domains: {})
      ...
      __initialize__ input_examples, input_arity, output_examples, output_arity,
                   arch, population_size, program_size, instructions,
