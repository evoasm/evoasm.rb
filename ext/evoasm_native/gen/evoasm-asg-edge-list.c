...
void
evoasm_asg_edge_list_clear(evoasm_asg_edge_list *free_list, evoasm_asg_edge_list_index start, evoasm_asg_edge_list_index end) {
  for(evoasm_asg_edge_list_index i = start; i < end - 1; i++) {
...
evoasm_success
evoasm_asg_edge_list_init(evoasm_asg_edge_list *free_list, evoasm_asg_edge_list_index capa) {
...
_evoasm_asg_edge_list_grow(evoasm_asg_edge_list *free_list) {
  evoasm_asg_edge_list_index new_capa = free_list->capa + free_list->capa / 2;
...
evoasm_asg_edge_list_delete(evoasm_asg_edge_list *free_list, evoasm_asg_edge *e) {
  evoasm_asg_edge_list_index idx = evoasm_asg_edge_list_index(free_list, e);
...
bool
evoasm_asg_edge_list_find(evoasm_asg_edge_list *free_list, evoasm_asg_edge *value, evoasm_asg_edge_list_index *index) {

  if(free_list->len == 0) return false;

  for(evoasm_asg_edge_list_index i = 0; i < free_list->capa; i++) {
