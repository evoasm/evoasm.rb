...
evoasm_asg_node_list_index(evoasm_asg_node_list *free_list, evoasm_asg_node *e) {
  return (uint32_t)(e - EVOASM_ASG_NODE_LIST_DATA(free_list));
}

static inline evoasm_asg_node *
evoasm_asg_node_list_get(evoasm_asg_node_list *free_list, uint32_t index) {
#if 0
...
evoasm_asg_node_list_push(evoasm_asg_node_list *free_list, evoasm_asg_node **ee, uint32_t *ridx) {
...
evoasm_success evoasm_asg_node_list_init(evoasm_asg_node_list *free_list, uint32_t capa);
