...
typedef uint32_t evoasm_asg_edge_list_index;

typedef struct evoasm_asg_edge_list {
  evoasm_asg_edge_list_index capa;
  evoasm_asg_edge_list_index len;
  evoasm_asg_edge_list_index first_free;
  evoasm_asg_edge_list_index last_free;
...
evoasm_asg_edge_list_get_index(evoasm_asg_edge_list *free_list, evoasm_asg_edge *e) {
  return (uint32_t)(e - EVOASM_ASG_EDGE_LIST_DATA(free_list));
}

static inline evoasm_asg_edge *
evoasm_asg_edge_list_get(evoasm_asg_edge_list *free_list, evoasm_asg_edge_list_index index) {
#if 0
...
evoasm_asg_edge_list_push(evoasm_asg_edge_list *free_list, evoasm_asg_edge **ee, evoasm_asg_edge_list_index *ridx) {
...

  {
    ...
    evoasm_asg_edge_list_index idx = free_list->first_free;
...
evoasm_success evoasm_asg_edge_list_init(evoasm_asg_edge_list *free_list, evoasm_asg_edge_list_index capa);
