...
evoasm_population_init(evoasm_population *pop, evoasm_search *search) {
  ...
  *pop = zero_pop;
  ...
  EVOASM_TRY(prot_failed, evoasm_buf_protect, &pop->buf,
      EVOASM_BUF_PROT_R | EVOASM_BUF_PROT_W | EVOASM_BUF_PROT_X);
...
evoasm_program_run(evoasm_program *program,
  ...
  if(!evoasm_buf_protect(program->buf, EVOASM_BUF_PROT_X)) {
    evoasm_assert_not_reached();
  }
  ...
  if(!evoasm_buf_protect(program->buf, EVOASM_BUF_PROT_R | EVOASM_BUF_PROT_W)) {
    evoasm_assert_not_reached();
  }
